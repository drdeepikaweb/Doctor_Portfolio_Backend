...
import { createDoctorAccount, getDoctorProfile, getConsultationDetails, completeConsultation, listConsultations, listContactMessages, loginDoctor, logoutDoctor, requestResetPassword, verifyResetPasswordOtp, resetPassword, } from "../controllers/doctor.controller.js";
import { requireDoctorAuth } from "../middleware/doctor-auth.js";
import { sanitizeBody } from "../middleware/sanitize.js";
import { validate } from "../middleware/validate.js";
import { createDoctorRules, loginDoctorRules, requestResetPasswordRules, verifyResetPasswordOtpRules, resetPasswordRules, } from "../validators/doctor.validator.js";

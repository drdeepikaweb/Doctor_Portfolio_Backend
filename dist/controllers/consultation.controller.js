...
export async function createConsultation(req, res) {
    try {
        ...
        if (is_reconsultation) {
            ...
            await notifyClinic("New online consultation request (Free Reconsultation)", `<h2>Online Consultation</h2>

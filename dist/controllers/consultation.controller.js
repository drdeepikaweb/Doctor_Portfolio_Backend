...
export async function createConsultation(req, res) {
    ...
    await notifyClinic("New online consultation request", `<h2>Online Consultation</h2><p><strong>Name:</strong> ${consultation.name}</p><p><strong>Age:</strong> ${consultation.age}</p><p><strong>Gender:</strong> ${consultation.gender}</p><p><strong>Phone:</strong> ${consultation.phone}</p><p><strong>Email:</strong> ${consultation.email || "Not provided"}</p><p><strong>Address:</strong> ${consultation.address}</p><p><strong>Symptoms:</strong> ${consultation.symptoms}</p><p><strong>Payment:</strong> ${paymentLabel} - Rs. ${consultation.consultation_fee}</p><p><strong>Documents:</strong> ${documentText}</p>`, `New online consultation request\nName: ${consultation.name}\nAge: ${consultation.age}\nGender: ${consultation.gender}\nPhone: ${consultation.phone}\nEmail: ${consultation.email || "Not provided"}\nPayment: ${paymentLabel} - Rs. ${consultation.consultation_fee}\nSymptoms: ${consultation.symptoms}\nDocuments: ${documentText}`);

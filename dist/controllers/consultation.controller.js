...
export async function createConsultation(req, res) {
    try {
        const { name, age, gender, phone, email, address, symptoms, payment_category, consultation_fee, aadhaar_no, razorpay_order_id, razorpay_payment_id, razorpay_signature, } = req.body;
